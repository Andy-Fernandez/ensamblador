...
start:
    ...
    ;Ahora lo recorremos y buscamos diferentes de 0
    ;Si el numero es difernte de 0 entonces continu
    ;amos la lectura eliminando todos los numeros
    ;parecidos o iguales
    lea si, v
    mov flag, 0
    mov aux, 0 
    ...
    loop_while2:
        ...
        mov bl, [si] ;3
        mov ax, bx
        ;compramos si nuestra flag es == 1
        cmp flag, 1                                          
        jge compararNumero ; si flag es >= 1 compara
        jmp buscarIguales
        
        ;si el numero >= 1 entonces podermos asignarlo 
        compararNumero: ; vamos que el ax sea mayo a nuestro aux
            cmp ax, aux ; si ax >= aux
            jge cambiarNumeroYFlag
            jmp continuarBuscando
    ...
    fin_while2: ; volver al inicio del loop
    ;#####    
